<template>
	<view :class="modal?'show-qrcode':'hide-qrcode'">
		<view class="box-qrcode"  @longtap="longtapCode">
			...
			<canvas class="canvas-qrcode" style="width:360rpx;height:360rpx" :canvas-id="qrcode_id">
				<!-- #ifndef MP -->
				<view v-if="modal&&is_themeImg" style="width:360rpx;height:360rpx" class="box-img-qrcode">
