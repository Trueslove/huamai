...
export default {
  ...
  methods: {
    getData() {
      this.$api
        .get(global.apiUrls.get_jbzhqb, { pageNum:this.pageNum,pageSize:10})
        .then((result) => {
          console.log(111)
