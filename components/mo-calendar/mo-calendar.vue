<template>
  <view class="mo-calendar-wrap">
    <!-- 日历选择 start -->
    <view class="mo-calendar-data mo-flex mo-justify-center mo-align-center mo-margin mo-height-72" v-if="changeTitle">
      <block v-if="changeYear">
        <view class="mo-arrow mo-left mo-flex mo-justify-between mo-align-center" @click="prevYear">
          <text class="iconfont icon-changyongicon-" :style="[yaColor]"></text>
        </view>
      </block>
      <block v-if="changeMonth">
        <view class="mo-arrow single mo-left mo-flex mo-justify-between mo-align-center" @click="prevMonth">
          <text class="iconfont icon-jiantouyou" :style="[maColor]"></text>
        </view>
      </block>
      <view class="mo-title mo-text-32 mo-text-333">{{ currentDate[0] }}{{i18n['年']}}{{ currentDate[1] }}{{i18n['月']}}</view>
      <block v-if="changeMonth">
        <view class="mo-arrow single mo-right mo-flex mo-justify-between mo-align-center" @click="nextMonth">
          <text class="iconfont icon-jiantouyou" :style="[maColor]"></text>
        </view>
      </block>
      <block v-if="changeYear">
        <view class="mo-arrow mo-flex mo-right mo-justify-between mo-align-center" @click="nextYear">
          <text class="iconfont icon-changyongicon-" :style="[yaColor]"></text>
        </view>
      </block>
    </view>
    <!-- 日历选择 end -->
    <!-- 星期 start -->
    <view class="mo-week mo-flex mo-justify-between mo-align-center mo-text-333 mo-height-72">
      <view class="mo-week-item mo-text-center" v-for="item in weekData" :key="item">{{ item }}</view>
    </view>
    <!-- 星期 end -->
    <!-- 日历 start -->
    <view class="mo-calendar mo-flex mo-justify-between mo-align-center mo-flex-wrap mo-text-333">
      <!-- mode == date || mode == range -->
      <view
        class="mo-calendar-item  mo-text-center"
      ...
      >
        <view
          class="mo-calendar-num mo-flex mo-justify-center mo-align-center"
        ...
        >
          {{ item.day }}
          <view class="mo-calendar-text" v-show="item.start">{{ startText }}</view>
          <view class="mo-calendar-text" v-show="item.end">{{ endText }}</view>
        </view>
      </view>
    </view>
    <!-- 日历 end -->
...
export default {
  ...
  methods: {
    ...
    getCalendar(y, m) {
      ...
      //这里塞入正常这个月的日期
      let week = [this.i18n['星期日'], this.i18n['星期一'], this.i18n['星期二'], this.i18n['星期三'], this.i18n['星期四'], this.i18n['星期五'], this.i18n['星期六']];
