<template>
  <view class="mo-page" :style="{ position: sticky ? 'sticky' : 'initial', top: top + 'px', 'z-index': zIndex }">
    <scroll-view class="mo-tab" scroll-x :scroll-left="moveX" :scroll-with-animation="animation" :style="{ height: height + 'rpx', 'line-height': height + 'rpx' }">
      <view :class="{'mo-flex':scrollspy}">
        <view
          class="mo-tab-item"
          ...
          obj
            ...
            objParent
              .boundingClientRect(function(data) {
                ...
                // 转为px  scoll-view接受的值为px
                _this.moveX = (moveX * windowWidth) / 750;
                // console.log('222222',dataLeft,parentWidth,targetWidth)
              })
              .exec();
        });
      }
